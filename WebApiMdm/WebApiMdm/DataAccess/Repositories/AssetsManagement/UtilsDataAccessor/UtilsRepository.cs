...
namespace WebApiMdm.DataAccess.Repositories.AssetsManagement.UtilsDataAccessor;
public class UtilsRepository : Repository, IUtilsRepository
{
    public UtilsRepository(IDbConnection connection, IAssetsManagementSqlQueryService sqlQueryService) : base(connection, sqlQueryService, "UtilsDataAccessor", "UtilsQueries.sql")
    {
    }
