...
namespace WebApiMdm.DataAccess.Repositories.AdventureWorks2019.UtilsDataAccessor;
public class UtilsRepository : Repository, IUtilsRepository
{
    public UtilsRepository(IDbConnection connection, IAdventureWorks2019SqlQueryService sqlQueryService) : base(connection, sqlQueryService, "UtilsDataAccessor", "UtilsQueries.sql")
    {
    }
